...
export class TemplateService {
  ...
  // Use current repository (sowonlabs/codecrew) for templates
  private readonly cdnBaseUrl = 'https://cdn.jsdelivr.net/gh/sowonlabs/codecrew@';
  private readonly githubRawUrl = 'https://raw.githubusercontent.com/sowonlabs/codecrew/';
  private readonly cacheDir = join(process.cwd(), '.codecrew', 'cache', 'templates');
