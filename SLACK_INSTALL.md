...
- [ ] Slack App 생성 완료
- [ ] Bot Token Scopes 4개 추가 (`app_mentions:read`, `chat:write`, `channels:history`, `channels:read`)
...
Bot Token Scopes가 부족합니다. Step 2로 돌아가서 4개 권한을 모두 추가하세요.
